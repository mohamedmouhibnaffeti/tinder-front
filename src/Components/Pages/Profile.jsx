                    ...
                    <div className="py-12 px-24 md:gap-8 gap-5 items-center flex flex-col rounded-lg border border-pink-700">
                        ...
                        <div className=" flex flex-col gap-2 md:self-start md:pl-44 lg:pl-0">
                            ...
                            <div className="flex gap-5 ">
                                <button className={`dark:text-gray-100 border ${data.gender === 'Male' ? ' dark:btn-light btn-dark' : 'bg-slate-600 border-white'} py-2 px-8 rounded-3xl md:w-44 w-32 transition delay-200 hover:scale-105 `} onClick={()=>onChangeHandler("gender", "Male")} > Male </button>
                                <button className={`dark:text-gray-100 border ${data.gender === 'Female' ? 'dark:btn-light btn-dark' : 'bg-slate-600 border-white'} py-2 px-8 rounded-3xl md:w-44 w-32 transition delay-200 hover:scale-105`} onClick={()=>onChangeHandler("gender", "Female")} > Female </button>
                            </div>
                        </div>
                        <div className=" flex flex-col gap-2 md:self-start md:pl-44 lg:pl-0">
                            <p className="dark:text-white font-semibold text-lg self-start">&nbsp; Show me </p>
                            <div className="flex gap-5 ">
                                <button className={`dark:text-gray-100 border ${data.showme === 'Male' ? 'dark:btn-light btn-dark' : 'bg-slate-600 border-white'} py-2 px-8 rounded-3xl md:w-44 w-32 transition delay-200 hover:scale-105`} onClick={()=>onChangeHandler("showme", "Male")} > Males </button>
                                <button className={`dark:text-gray-100 border ${data.showme === 'Female' ? 'dark:btn-light btn-dark' : 'bg-slate-600 border-white'} py-2 px-8 rounded-3xl md:w-44 w-32 transition delay-200 hover:scale-105`} onClick={()=>onChangeHandler("showme", "Female")} > Females </button>
                            </div>
                        </div>
                        <div className=" flex flex-col gap-2">
